...
namespace SonicModel; // Change this to your namespace

[LandfallPlugin]
public class BoneProjectionModelSwap {
    public static Harmony harmony;
    public static string GUID = "AnthonyStai.SonicModel"; // change this as well
    public static string category = "Sonic Model"; // and this
    ...
    static BoneProjectionModelSwap() {
        ...
        AssetBundle assetBundle = AssetBundle.LoadFromFile(Path.Combine(AssemblyDirectory, "sonic.assetbundle"));
        if (assetBundle == null) {
            Debug.Log("Failed to load AssetBundle!");
            return;
        }

        prefab = assetBundle.LoadAsset<GameObject>("Sonic");
