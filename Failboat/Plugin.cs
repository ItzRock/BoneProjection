...
namespace FailboatModel; // Change this to your namespace

[LandfallPlugin]
public class BoneProjectionModelSwap {
    public static Harmony harmony;
    public static string GUID = "AnthonyStai.Failboat"; // change this as well
    public static string category = "Failboat Model"; // and this
    ...
    static BoneProjectionModelSwap() {
        ...
        AssetBundle assetBundle = AssetBundle.LoadFromFile(Path.Combine(AssemblyDirectory, "failboat.assetbundle"));
        if (assetBundle == null) {
            Debug.Log("Failed to load AssetBundle!");
            return;
        }

        prefab = assetBundle.LoadAsset<GameObject>("Failboat");
